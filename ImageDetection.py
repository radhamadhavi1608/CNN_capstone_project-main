...
def predict_and_draw(image):
    ...
    direcrtoryPath = "C:\\Users\\radha\\GL-Workspace\\Capstone-1\\CNN_capstone_project-main\\Capstone\\TestDataSet\\*\\*"
...
def model_training():
    if request.method == 'POST':
        ...
        import pandas as pd
        annotationsTrainDF = pd.read_csv("C:\\Users\\radha\\GL-Workspace\\Capstone-1\\CNN_capstone_project-main\\files\\Train_Annotations.csv")
        annotationsTrainDF.rename(columns={'Bounding Box coordinates': 'xmin'}, inplace=True)
        annotationsTrainDF.rename(columns={'Unnamed: 2': 'ymin'}, inplace=True)
        annotationsTrainDF.rename(columns={'Unnamed: 3': 'xmax'}, inplace=True)
        annotationsTrainDF.rename(columns={'Unnamed: 4': 'ymax'}, inplace=True)
        ...
        trainDataSetPath = "C:\\Users\\radha\\GL-Workspace\\Capstone-1\\CNN_capstone_project-main\\Capstone\\Subset\\*\\*"
...
def init_training(train_df,no_of_epochs):
    ...
    checkpoint_filepath = 'C:\\Temp\\CapstoneProject\\tempCSV\\checkpoint'
    ...
    plt.savefig('C:\\Users\\radha\\GL-Workspace\\Capstone-1\\CNN_capstone_project-main\\static\\images\\ClassAccuracyInImage.jpg')
