...
def model_training():
    try:
        if request.method == 'POST':
            ...
            fileName="C:\\Users\\radha\\GL-Workspace\\Capstone-1\\CNN_capstone_project-main\\files\\Train_Annotations.csv"
            direcrtoryPath="C:\\Users\radha\GL-Workspace\Capstone-1\CNN_capstone_project-main\\Capstone\\Subset\\*\\*"
            madf = make_annotation_dataframe(fileName, direcrtoryPath)
            (df, annotationsTrainDF) = madf.prepare_dataframe()
            mt = model_train()
